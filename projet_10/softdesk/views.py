...
class ProjectsView(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.kwargs.get('pk'):
            ...
            get_object_or_404(Contributors, project_id=project, user_id=self.request.user)
...
class UsersView(ModelViewSet):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response(users.filter(id__in=contributors_id).values('id', 'email',
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response("Il faut entrer des chiffres.", status=status.HTTP_404_NOT_FOUND)
        try:
        ...
        try:
            ...
            return Response("La personne recherchée n'existe pas.", status=status.HTTP_404_NOT_FOUND)
        try:
            contributor = Contributors.objects.get(project_id=project, user_id=user_to_delete)
        except ObjectDoesNotExist:
            return Response('La personne ne figure pas dans la liste des contributeurs.', status=status.HTTP_404_NOT_FOUND)
    ...
    def create(self, request, *args, **kwargs):
        if not self.kwargs.get('pk'):
            ...
            try:
                ...
                return Response("le projet n'est pas à toi.", status=status.HTTP_404_NOT_FOUND)
            ...
            if request.POST.get('email'):
                ...
                try:
                    ...
                    return Response("Cette personne est déjà associé à ce projet.", status=status.HTTP_404_NOT_FOUND)
                except ObjectDoesNotExist:
                    pass
                try:
                    ...
                    return Response("Erreur pendant la sauvegarde.", status=status.HTTP_404_NOT_FOUND)
